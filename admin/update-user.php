      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col-md-offset-4 col-md-4">
                  ...
                  $sql = "select * from user where user_id={$id_no}";
                      ...
                      <div class="form-group">
                          ...
                          <?php
                            if($rows['role'] == 1)
                            {
                                ...
                                <option selected value='1' selected >Admin</option>";
                            }
                            else {
                  ...
                  if(isset($_POST['submit']))
                  {
                      ...
                      $sql1 = "UPDATE user set first_name = '{$fname}',last_name = '{$lname}',username = '{$user}',role = '{$role}' where user_id={$id_no}";
